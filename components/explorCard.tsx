        ...
        <div className="relative inline-block w-full transition-transform duration-300 ease-in-out transform">
          <div className="rounded-lg">
            <div className="relative flex justify-center overflow-hidden rounded-lg h-60">
              ...
              <span className="absolute top-0 left-0 z-10 inline-flex px-3 py-2 mt-3 ml-3 text-sm font-medium text-white rounded-lg select-none bg-emerald-500">
                {" "}
                Featured{" "}
              </span>
            </div>
            <div>
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-4 pt-3 pb-3 mt-2 ">
                <p className="flex items-center xl:flex-row xl:items-center">
                  <svg
                    className="inline-block w-5 h-5 mr-3 fill-current xl:h-4 xl:w-4"
