const Card = () => {
  return (
    <div className="relative w-full max-w-sm pt-6 mx-auto">
      <a
        href="#"
      ...
      >
        <div className="rounded-lg">
          ...
          <div className="">
            <div className="grid grid-cols-2 mt-4">
              <div className="flex items-center">
                <div className="relative">
                  <h2
                    className="text-base font-medium text-white line-clamp-1 md:text-lg"
                    title="New York"
                  >
                    Statue of Liberty
                  </h2>
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-4 pt-3 pb-3 mt-2 border-t border-b border-gray-200">
              <p className="flex items-center text-white xl:flex-row xl:items-center">
                <svg
                  className="inline-block w-5 h-5 mr-3 text-white fill-current xl:h-4 xl:w-4"
